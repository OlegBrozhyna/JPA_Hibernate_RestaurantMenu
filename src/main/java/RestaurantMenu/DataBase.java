...
public class DataBase {
    ...
    private EntityManagerFactory entityManagerFactoryy;
    ...
    public void connect(final String persistenceUnit) {
        this.entityManagerFactoryy = Persistence.createEntityManagerFactory(persistenceUnit);
        entityManager = this.entityManagerFactoryy.createEntityManager();
    ...
    public void disconnect() {
        ...
        this.entityManagerFactoryy.close();
    ...
    public Collection<Dish> selectionByPrice(final double priceMin, final double priceMax) {
        return selection("price", priceMin, priceMax);
    }

    public Collection<Dish> selectionByWeight(final double weightMin, final double weightMax) {
        return selection("weight", weightMin, weightMax);
    }

    public Collection<Dish> selectionByDiscount(final double discountMin, final double discountMax) {
    ...
    private Collection<Dish> selection(final String name, final double valueMin, final double valueMax) {
